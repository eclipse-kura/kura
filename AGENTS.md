  ...
  - **XML header template**:
    ```
        ...
        Contributors:
         {holder}
    ```
    Always update copyright year to the current year if editing files; add `// Content with portions generated by generative AI platform` after copyright header.
