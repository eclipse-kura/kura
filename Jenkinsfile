                        ...
                        withSonarQubeEnv {
                            sh '''
                                mvn -f kura/pom.xml sonar:sonar \
                                    ...
                                    -Dsonar.exclusions=org.eclipse.kura.web2/**/*.java,org.eclipse.kura.nm/src/main/java/org/freedesktop/**/*,org.eclipse.kura.nm/src/main/java/fi/w1/**/*,org.eclipse.kura.linux.gpio.libgpiod/src/main/java/org/eclipse/kura/linux/gpio/libgpiod1/LibGpiodV1Native.java
                                    -Dsonar.test.exclusions=test/**/*.java,test-util/**/*.java
                            '''
                        }
                    }
                }
