...
h1. Kura Development Environment
...
To set up your Kura project workspace, you will need to download the ["Kura User Workspace archive":http://www.eclipse.org/downloads/download.php?file=/kura/releases/0.7.0/kura-raspberry-pi-jars_0.7.0.zip]
