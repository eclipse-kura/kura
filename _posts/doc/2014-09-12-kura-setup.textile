...
Download the current distribution of Eclipse for your OS from ["http://www.eclipse.org/downloads/":http://www.eclipse.org/downloads/].  Choose the Eclipse IDE for Java EE Developers.
...
To set up your Kura project workspace, you will need to download the <a href="https://www.eclipse.org/kura/downloads.php" target="_blank">Kura User Workspace archive</a>.
