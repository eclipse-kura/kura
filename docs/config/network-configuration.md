...
![Net DHCPNAT](./images/NetDHCPNAT.png)
...
The Network configuration can be modified using the ESF Gateway Administration Console, as described above, using the Configuration Service or by appling a proper [snapshot](../admin/snapshot-management.md).
