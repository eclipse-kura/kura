...
if ((action.id == \"org.freedesktop.login1.reboot-multiple-sessions\" ||
    ...
    WPA_SUPPLICANT_CONF_PATH=/etc/dbus-1/system.d/wpa_supplicant.conf
    if [ ! -f "${WPA_SUPPLICANT_CONF_PATH}" ] && [ -f /usr/share/dbus-1/system.d/wpa_supplicant.conf ]; then
        WPA_SUPPLICANT_CONF_PATH=/usr/share/dbus-1/system.d/wpa_supplicant.conf
    fi
...
function delete_users {
    ...
    WPA_SUPPLICANT_CONF_PATH=/etc/dbus-1/system.d/wpa_supplicant.conf
    if [ ! -f "${WPA_SUPPLICANT_CONF_PATH}.save" ] && [ -f /usr/share/dbus-1/system.d/wpa_supplicant.conf.save ]; then
        WPA_SUPPLICANT_CONF_PATH=/usr/share/dbus-1/system.d/wpa_supplicant.conf
    fi
    if [ -f "${WPA_SUPPLICANT_CONF_PATH}.save" ]; then
        mv "${WPA_SUPPLICANT_CONF_PATH}.save" "${WPA_SUPPLICANT_CONF_PATH}"
    fi
}
