 ...
 *  Eurotech
 *******************************************************************************/
package org.eclipse.kura.example.logprovider;
...
public class ExampleLogProvider implements ConfigurableComponent, LogProvider {

    private static final Logger logger = LoggerFactory.getLogger(ExampleLogProvider.class);
    ...
    protected void activate(Map<String, Object> properties) {
        logger.info("Activating ExampleLogProvider...");
        this.filePath = (String) properties.get("logFilePath");
        this.readerThread = new FileLogReader(this.filePath);
        this.readerThread.start();
        logger.info("Activating ExampleLogProvider... Done.");
    }

    protected void deactivate() {
        logger.info("Deactivating ExampleLogProvider...");
        this.readerThread.interrupt();
        logger.info("Deactivating ExampleLogProvider... Done.");
    }

    public void updated(Map<String, Object> properties) {
        logger.info("Updated ExampleLogProvider...");
        this.readerThread.interrupt();
        this.filePath = (String) properties.get("logFilePath");
        this.readerThread = new FileLogReader(this.filePath);
        this.readerThread.start();
        logger.info("Updated ExampleLogProvider... Done.");
    }
    ...
    public class FileLogReader extends Thread {
        ...
        public void run() {
            ...
            try (RandomAccessFile file = new RandomAccessFile(this.logFile, "r")) {
                ...
                logger.error("Unexpected exception in ExampleLogProvider: {}", e.getStackTrace());
            } finally {
