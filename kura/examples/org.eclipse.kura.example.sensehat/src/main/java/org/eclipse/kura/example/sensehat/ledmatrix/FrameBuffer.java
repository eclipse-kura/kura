package org.eclipse.kura.example.sensehat.ledmatrix;
...
public class FrameBuffer {
	...
	public static FrameBuffer getFrameBuffer(ComponentContext ctx) {
		...
		alphabet = new Alphabet(ctx.getBundleContext().getBundle().getResource("src/main/resources/sense_hat_text.pbm"));
