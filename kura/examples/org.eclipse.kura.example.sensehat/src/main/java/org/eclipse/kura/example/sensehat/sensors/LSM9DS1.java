...
public class LSM9DS1 {
	...
	public static int read(int device, int register) throws KuraException {
		...
		try {
			...
			s_logger.error("Unable to read/write to I2C device", e);
	...
	public static void disableAccelerometer() {
		...
		try {
			...
			write(ACC_DEVICE, CTRL_REG6_XL, ctrl_reg & 0x0000001F);
		} catch (KuraException e) {
			s_logger.info(e.toString());
		}
	...
	public static void enableGyroscope() {
		...
		try {
			write(ACC_DEVICE, CTRL_REG1_G, 0x00000069);
			write(ACC_DEVICE, CTRL_REG3_G, 0x00000044);
			GyroSampleRate = 119;
		} catch (KuraException e) {
			s_logger.info(e.toString());
		}
	...
	public static void disableGyroscope() {
		...
		try {
			...
			write(ACC_DEVICE, CTRL_REG1_G, ctrl_reg & 0x0000001F);
		} catch (KuraException e) {
			s_logger.info(e.toString());
		}
	...
	public static void enableMagnetometer() {
		...
		try {
			// Enable magnetometer with default settings (TEMP_COMP=1, DO=20Hz, FS=+/-400uT)
			write(MAG_DEVICE, CTRL_REG1_M, 0x00000094);
			write(MAG_DEVICE, CTRL_REG2_M, 0x00000000);
			write(MAG_DEVICE, CTRL_REG3_M, 0x00000000);
		} catch (KuraException e) {
			s_logger.info(e.toString());
		}
	...
	public static void disableMagnetometer() {
		...
		int ctrl_reg = 0x00000000;
		try {
			ctrl_reg = read(MAG_DEVICE, CTRL_REG3_M) & 0x000000FF;
			write(MAG_DEVICE, CTRL_REG3_M, ctrl_reg | 0x00000003);
		} catch (KuraException e) {
			s_logger.info(e.toString());
		}
