...
public abstract class TritonServerServiceAbs implements InferenceEngineMetricsService, ConfigurableComponent {
    ...
    private void stopManagedInstance() {
        if (isNull(this.tritonServerInstanceManager)) {
            logger.debug("Triton server instance manager is not initialized. Nothing to stop.");
        } else {
            ...
            this.tritonServerInstanceManager = null;
        }
