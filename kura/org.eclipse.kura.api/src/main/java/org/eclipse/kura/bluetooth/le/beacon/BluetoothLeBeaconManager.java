...
public interface BluetoothLeBeaconManager<T extends BluetoothLeBeacon> {
     ...
     */
    public BluetoothLeBeaconScanner<T> newBeaconScanner(
            BluetoothLeAdapter adapter, BluetoothLeBeaconDecoder<T> decoder);
     ...
     */
    public BluetoothLeBeaconAdvertiser<T> newBeaconAdvertiser(
            BluetoothLeAdapter adapter, BluetoothLeBeaconEncoder<T> encoder)
            throws KuraBluetoothBeaconAdvertiserNotAvailable;
