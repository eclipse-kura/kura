 ...
 * The approach is <a href=" http://www.jeremias-maerki.ch/wordpress/de/2010/04/22/osgi-ds-configuring-multiple-instances-of-a-component/">using OSGi Declative Services to configure multiple instances of a component</a>.
 * <br><br>
...
public interface ConfigurationService 
{
	 ...
	 * properties.
	 * 
	 * @param factoryPid the ID of the factory.
	 * @param pid the value of the {@link ConfigurationService#KURA_SERVICE_PID}
	 * that will be set in the component configuration properties.
	 * @param properties an optional map of properties describing the component configuration.
	 ...
	 * If <i>properties</i> is not null, the Configuration Service will first remove {@link ConfigurationService#KURA_SERVICE_PID}
	 * from the provided properties and then it will merge them with the initial map.
	 * @param takeSnapshot if set to true a snapshot will be taken.
	 * @throws KuraException if pid is null, it already exists or creation fails.
	 * 
	 * @since {@link org.eclipse.kura.configuration} 1.1.0
	 */
	public void createFactoryConfiguration(String factoryPid, String pid, Map<String,Object> properties, boolean takeSnapshot) throws KuraException;
	 ...
	 * 
	 * @param pid the PID of the component instance to delete.
	 * @param takeSnapshot if set to true a snapshot will be taken.
	 * @throws KuraException if the PID is not found or if the component instance was not created
