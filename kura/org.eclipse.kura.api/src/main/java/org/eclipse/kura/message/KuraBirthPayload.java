...
public class KuraBirthPayload extends KuraPayload {
     ...
     * @since 3.0
     */
    private static final String MODEM_EID_KEY = "modem_eid";
     ...
     * @since 3.0
     */
    public String getModemEid() {
        return (String) getMetric(MODEM_EID_KEY);
    }
    ...
    public static class KuraBirthPayloadBuilder {
         ...
         * @since 3.0
         */
        public KuraBirthPayloadBuilder withModemEid(String modemEid) {
            this.modemEid = modemEid;
            return this;
        }
        ...
        public KuraBirthPayload build() {
            ...
            birthPayload.addMetric(MODEM_EID_KEY, this.modemEid);
