 ...
 * The default implementation is a Factory Component. A new istance of a {@link #CloudConnectionStatusService} will be instantiated
 * for each communication stack.
 * The default CloudConnectionStatusService will have its <b>kura.service.pid</b> equals to <b>org.eclipse.kura.status.CloudConnectionStatusService</b><br/>
 * Subsequent Communication Stacks will instantiate a relevant CloudConnectionStatusService with the appropriate postfix.<br/>
 * e.g. The CloudConnectionStatusService for a Communication Stack generated by a org.eclipse.kura.cloud.CloudService-foo will have its
 ...
 * The configuration is defined by a key value pair, where key is a URL-like string defining the service, and value is the entity responsible
 * to show the Cloud Connection Status.
 * It can be either a LED, the system log or none.
 * Configuration for specific istances of the CloudConnectionStatusService is achieved by correctly formatting the URL-like key.<br/>
 ...
 * <br/>
 * e.g. The key-value pair to link the CloudConnectionStatusService generated for the "foo" stack (see above) to LED number 25 would be:<br/>
