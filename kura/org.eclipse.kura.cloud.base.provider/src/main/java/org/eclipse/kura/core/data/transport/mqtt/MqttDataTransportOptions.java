...
public @interface MqttDataTransportOptions {
    ...
    @AttributeDefinition(
            name = "Broker-url",
            description =
                    "URL of the MQTT broker to connect to, specifying protocol, hostname and port (for example mqtt://your.broker.url:1883/ ). Supported protocols are mqtt, mqtts, ws and wss.")
