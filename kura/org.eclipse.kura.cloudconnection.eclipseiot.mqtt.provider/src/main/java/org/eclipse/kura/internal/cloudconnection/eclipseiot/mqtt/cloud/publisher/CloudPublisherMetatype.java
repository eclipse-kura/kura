...
@ObjectClassDefinition(
        id = "org.eclipse.kura.cloudconnection.eclipseiot.mqtt.CloudPublisher",
        name = "CloudPublisher",
        description =
                "The Eclipse IoT Cloud Publisher provides a service to publish messages to a cloud platform compatible with the Eclipse IoT MQTT topic namespace.")
