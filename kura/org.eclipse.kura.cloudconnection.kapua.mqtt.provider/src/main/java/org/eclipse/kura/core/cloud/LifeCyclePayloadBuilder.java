...
public class LifeCyclePayloadBuilder {
    ...
    public KuraBirthPayload buildBirthPayload() {
        ...
        String payloadEncoding = this.cloudServiceImpl
        ...
        if (this.cloudServiceImpl.imei != null
                && this.cloudServiceImpl.imei.length() > 0
                && !this.cloudServiceImpl.imei.equals(ERROR)) {
            birthPayloadBuilder.withModemImei(this.cloudServiceImpl.imei);
        }
        if (this.cloudServiceImpl.iccid != null
                && this.cloudServiceImpl.iccid.length() > 0
                && !this.cloudServiceImpl.iccid.equals(ERROR)) {
            birthPayloadBuilder.withModemIccid(this.cloudServiceImpl.iccid);
        }

        if (this.cloudServiceImpl.imsi != null
                && this.cloudServiceImpl.imsi.length() > 0
        ...
        if (this.cloudServiceImpl.modemFwVer != null
                && this.cloudServiceImpl.modemFwVer.length() > 0
    ...
    private void appendActiveNetworkInterfaces(
        ...
        this.cloudServiceImpl.getNetworkService().ifPresent(ns -> {
            try {
    ...
    private List<ModemInterfaceStatus> getConnectedModemsWithIp(Set<String> reportedInterfaceNames) {
        ...
        this.cloudServiceImpl.getNetworkStatusService().ifPresent(networkStatusService -> {
            try {
    ...
    private Optional<String> serializeExtendedProperties() {
        final Optional<ExtendedProperties> extendedProperties =
                this.cloudServiceImpl.getSystemService().getExtendedProperties();
