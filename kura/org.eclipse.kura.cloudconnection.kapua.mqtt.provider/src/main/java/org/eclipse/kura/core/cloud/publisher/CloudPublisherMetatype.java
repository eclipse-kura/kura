...
public @interface CloudPublisherMetatype {
    ...
    @AttributeDefinition(
            ...
            description =
                    "The desired quality of service for the messages that have to be published. If Qos is 0, the message is delivered at most once, or it is not delivered at all. If Qos is set to 1, the message is always delivered at least once.")
    int qos() default 0;
    ...
    @AttributeDefinition(
            ...
            options = {@Option(label = "Data", value = "data"), @Option(label = "Control", value = "control")},
    ...
    @AttributeDefinition(
            ...
            min = "0",
            description =
                    "Message priority. Priority level 0 (highest) should be used sparingly and reserved for messages that should be sent with the minimum latency. Default is set to 7.")
