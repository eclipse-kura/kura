...
@ObjectClassDefinition(
        id = "org.eclipse.kura.cloud.subscriber.CloudSubscriber",
        name = "CloudSubscriber",
        description =
                "The CloudSubscriber allows to define the subscribe topic and notify the associated applications when a subscription event happens.")
