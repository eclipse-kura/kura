...
public class StackComponentOptions<T> {
    ...
    private static final Property<String> CLOUD_ENDPOINT_SERVICE_PID =
            new Property<>(CloudConnectionConstants.CLOUD_ENDPOINT_SERVICE_PID_PROP_NAME.value(), String.class);
