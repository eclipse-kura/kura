...
@ObjectClassDefinition(
        id = "org.eclipse.kura.cloudconnection.sparkplug.mqtt.transport.SparkplugDataTransport",
...
public @interface SparkplugDataTransportMetatype {
    ...
    @AttributeDefinition(
            name = "Server URIs",
            description =
                    "List of space-separated URIs of the MQTT brokers to connect to.                           Supported types of connection are tcp: and ssl:. URIs must not end with /.                           If a primary.host.application.id has been set, the client will cycle                           over the list until a Primary Host Application becomes online.")
    ...
    @AttributeDefinition(
            ...
            description =
                    "Specifies, as an OSGi target filter, the pid of the SslManagerService used to create SSL connections.")
