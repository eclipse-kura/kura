...
@ObjectClassDefinition(
        id = "org.eclipse.kura.configuration.change.manager.ConfigurationChangeManager",
        ...
        icon = @Icon(resource = "OSGI-INF/configurationChangeManagerLogo.png", size = 32))
public @interface ConfigurationChangeManagerMetatype {
    ...
    @AttributeDefinition(
            ...
            description =
                    "Specifies, as an OSGi target filter, the pid of the Cloud Publisher used to publish messages             to the cloud platform.")
    ...
    @AttributeDefinition(
            ...
            min = "0",
            description =
                    "Delay before notifications are sent. A large delay accumulates notifications into a single message.    A delay of 0 will send the notifications as soon as they arrive, without accumulation.")
