...
@ObjectClassDefinition(
        id = LoginBannerServiceOptions.PID,
        name = "Login Banner", //
        description =
                "This component allows to enable and configure pre and post login banners that can be shown by Kura user interfaces.")
...
public @interface LoginBannerServiceOptions {
    ...
    @AttributeDefinition(
            name = "Pre Login Banner Content", //
            description = "The message to be shown in the pre login banner, if the feature is enabled.|TextArea")
    public String pre_login_banner_content() default
            "WARNING: This is a secure system. The details of this login attempt have been recorded for future inspection by the system administrator. Log out now if you are not authorized to use this device.";

    @AttributeDefinition(
            name = "Post Login Banner Enabled", //
    ...
    @AttributeDefinition(
            name = "Post Login Banner Content", //
