...
public class PKCS11KeystoreServiceOptions {
    ...
    private static final Property<String> ENABLED_MECHANISMS_PROPERTY =
            new Property<>("enabled.mechanisms", String.class);
    private static final Property<String> DISABLED_MECHANISMS_PROPERTY =
            new Property<>("disabled.mechanisms", String.class);
    ...
    public PKCS11KeystoreServiceOptions(final Map<String, Object> properties, final String ownPid) {
        ...
        this.enabledMechanisms = ENABLED_MECHANISMS_PROPERTY
                .getOptional(properties)
                .filter(s -> !s.trim().isEmpty());
        this.disabledMechanisms = DISABLED_MECHANISMS_PROPERTY
                .getOptional(properties)
                .filter(s -> !s.trim().isEmpty());
        this.attributes = ATTRIBUTES_PROPERTY
                .getOptional(properties)
                .filter(s -> !s.trim().isEmpty());
        this.crlStorePath =
                CRL_STORE_PATH.getOptional(properties).filter(s -> !s.trim().isEmpty());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(attributes, other.attributes)
                && Objects.equals(crlStorePath, other.crlStorePath)
                && Objects.equals(disabledMechanisms, other.disabledMechanisms)
                && Objects.equals(enabledMechanisms, other.enabledMechanisms)
                && Objects.equals(libraryPath, other.libraryPath)
                && Objects.equals(ownPid, other.ownPid)
    ...
    public Optional<String> buildSunPKCS11ProviderConfig() {
        ...
        if (enabledMechanisms.isPresent()) {
            builder.append("enabledMechanisms = { ")
                    .append(enabledMechanisms.get())
                    .append(" }\n");
        }

        if (disabledMechanisms.isPresent()) {
            builder.append("disabledMechanisms = { ")
                    .append(disabledMechanisms.get())
                    .append(" }\n");
        }
