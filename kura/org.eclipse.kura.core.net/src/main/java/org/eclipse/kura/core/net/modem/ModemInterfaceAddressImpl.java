...
public class ModemInterfaceAddressImpl extends NetInterfaceAddressImpl implements ModemInterfaceAddress {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + (int) (this.m_bytesReceived ^ this.m_bytesReceived >>> 32);
        result = prime * result + (int) (this.m_bytesTransmitted ^ this.m_bytesTransmitted >>> 32);
        result = prime * result + (this.m_connectionStatus == null ? 0 : this.m_connectionStatus.hashCode());
        result = prime * result + (this.m_connectionType == null ? 0 : this.m_connectionType.hashCode());
        result = prime * result + (this.m_isRoaming ? 1231 : 1237);
        result = prime * result + this.m_signalStrength;
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.m_signalStrength != other.m_signalStrength) {
            return false;
        }
        return true;
    }
