...
public class CloudDeploymentHandlerTest extends TestCase {
	...
	private static final String DP_NAME = "org.eclipse.kura.test.helloworld"; // <IAB>
	private static final String DP_VERSION = "1.0.0";
	//private static final String BUNDLE_NAME = "org.eclipse.kura.app.helloworld";
	private static final String BUNDLE_NAME = "org.eclipse.kura.test.helloworld"; // <IAB>
	//private static final String BUNDLE_VERSION = "1.0.0.201211061655";
	private static final String BUNDLE_VERSION = "1.0.0.201407161223"; // <IAB>
	...
	public void testExecUninstallDeploymentPackage() throws Exception {
		...
		payload.setBody("org.eclipse.kura.test.helloworld".getBytes("UTF-8")); // <IAB>
