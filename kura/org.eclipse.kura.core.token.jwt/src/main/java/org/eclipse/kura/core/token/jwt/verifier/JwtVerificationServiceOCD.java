...
@ObjectClassDefinition(
        id = "org.eclipse.kura.core.token.jwt.verifier.JwtVerificationService", //
        name = "JWT Verification Service", //
        description =
                "The JwtVerificationService verifies JSON Web Tokens. Can verify tokens are signed with RS256, using an RSA"
