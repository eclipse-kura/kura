...
@ObjectClassDefinition(
        id = "org.eclipse.kura.core.db.H2DbService",
        name = "DbService",
...
public @interface H2DbServiceConfig {
    ...
    @AttributeDefinition(
            ...
            required = true,
            min = "5",
            description = "H2DbService instances support running periodic checkpoints to ensure data consistency. This parameter specifies"
                    + " the interval in seconds between two successive checkpoints. This setting has no effect for in-memory database instances.")
    ...
    @AttributeDefinition(
            ...
            required = true,
            min = "0",
            description = "H2DbService instances support running periodic defragmentation. This parameter specifies the interval in minutes beetween"
                    + " two successive checkpoints, set to zero to disable. This setting has no effect for in-memory database instances."
                    + " Existing database connections will be closed during the defragmentation process and need to be reopened by the applications.")
    ...
    @AttributeDefinition(
            ...
            required = true,
            min = "1",
            description = "The H2DbService manages connections using a connection pool. This parameter defines the maximum number of"
