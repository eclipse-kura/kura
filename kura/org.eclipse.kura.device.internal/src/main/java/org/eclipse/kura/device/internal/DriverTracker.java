...
public final class DriverTracker extends ServiceTracker<Object, Object> {
	...
	/** The Base Device Instance */
	private final BaseDevice m_device;
	 ...
	 */
	public DriverTracker(final BundleContext context, final BaseDevice device, final String driverId)
			throws InvalidSyntaxException {
	...
	public void open() {
		...
		try {
			...
			s_logger.error("Exception while searching for drivers by the driver tracker...."
