...
/**
 * The Class {@link IBeaconOptions} is responsible to provide all the required
 * configurable options for the iBeacon Driver.<br/>
 * <br/>
 *
 * The property to configure an iBeacon Driver is as follows:
 * <ul>
 * <li>iname</li>
 * </ul>
 */
final class IBeaconOptions {

    private static final String INAME = "iname";
    private final Map<String, Object> properties;

    /**
     * Instantiates a new iBeacon options.
     *
     * @param properties
     *            the properties
     ...
     */
    IBeaconOptions(final Map<String, Object> properties) {
