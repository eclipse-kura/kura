...
@ObjectClassDefinition(
        id = "org.eclipse.kura.event.publisher.EventPublisher",
        name = "EventPublisher",
        description = "")
public @interface EventPublisherMetatype {
    ...
    @AttributeDefinition(
            ...
            description =
                    "The desired quality of service for the log messages that have to be published. If Qos is 0,             the log message is delivered at most once, or it is not delivered at all. If Qos is set to 1, the message             is always delivered at least once.")
    int qos() default 0;
