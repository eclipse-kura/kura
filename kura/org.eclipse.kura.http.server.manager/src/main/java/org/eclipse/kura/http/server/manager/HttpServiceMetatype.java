...
@ObjectClassDefinition(
        id = "org.eclipse.kura.http.server.manager.HttpService",
        name = "HttpService",
        description =
                "This service allows the user to enable and configure the http and https connectors in Kura web server. Every change to this service will cause a restart of the web server and a possible temporary UI unavailability.")
public @interface HttpServiceMetatype {
    ...
    @AttributeDefinition(
            ...
            max = "65535",
            description =
                    "Specifies a list of ports for unencrypted HTTP. If set to an empty list, unencrypted HTTP will be disabled.")
    int http_ports();
    ...
    @AttributeDefinition(
            ...
            max = "65535",
            description =
                    "Specifies a list of ports for HTTPS without client side certificate authentication. If set to an empty list, HTTPS without client side certificate authentication will be disabled.")
    int https_ports();
    ...
    @AttributeDefinition(
            ...
            max = "65535",
            description =
                    "Specifies a list of ports for HTTPS with client side certificate authentication. If set to an empty list, HTTPS with client side certificate authentication will be disabled.")
    int https_client_auth_ports();

    @AttributeDefinition(
            name = "KeystoreService Target Filter",
            description =
                    "Specifies, as an OSGi target filter, the pid of the KeystoreService used to manage the HTTPS Keystore.")
    ...
    @AttributeDefinition(
            ...
            description =
                    "Specifies the mode for performing revocation check. This parameter is ignored if Revocation Check Enabled is set to false.")
    ...
    @AttributeDefinition(
            ...
            required = false,
            description =
                    "Specifies whether the revocation soft fail is enabled or not. If it is enabled and the gateway is not able to verify the revocation status of a client certificate (for example due to a connectivity problem), the certificate will be rejected. This parameter is ignored if Revocation Check Enabled is set to false.")
