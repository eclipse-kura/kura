 ...
 */
public class LibGpiodV2GPIOService implements GPIOService {
    ...
    private void discoverChipPins(String chipPath) {
        ...
        try {
            ...
            // Get chip info
            chipInfo = LibGpiodV2Native.INSTANCE.gpiod_chip_get_info(chip);
            if (chipInfo == null) {
                return;
            }

            String chipName = LibGpiodV2Native.INSTANCE.gpiod_chip_info_get_name(chipInfo);
            long numLines = LibGpiodV2Native.INSTANCE.gpiod_chip_info_get_num_lines(chipInfo);

            // Discover individual pins
            for (int offset = 0; offset < numLines; offset++) {
                Pointer lineInfo = null;
                try {
                    lineInfo = LibGpiodV2Native.INSTANCE.gpiod_chip_get_line_info(chip, offset);
                    if (lineInfo != null) {
                        String lineName = LibGpiodV2Native.INSTANCE.gpiod_line_info_get_name(lineInfo);
                        ...
                        availablePins.put(globalPin, pinName);
                    ...
                    if (lineInfo != null) {
                        LibGpiodV2Native.INSTANCE.gpiod_line_info_free(lineInfo);
                    }
                }
            }
            ...
            if (chipInfo != null) {
                LibGpiodV2Native.INSTANCE.gpiod_chip_info_free(chipInfo);
            }
            if (chip != null) {
    ...
    public KuraGPIOPin getPinByName(String pinName) {
        return getPinByName(pinName, defaultDirection, defaultMode, defaultTrigger);
    }
    ...
    public KuraGPIOPin getPinByName(String pinName, KuraGPIODirection direction, KuraGPIOMode mode,
        ...
        // Create the pin
        KuraGPIOPin pin = LibGpiodV2PinFactory.createPin(chipPath, offset, direction, mode, trigger, pinName);
    ...
    public KuraGPIOPin getPinByTerminal(int terminal) {
        return getPinByTerminal(terminal, defaultDirection, defaultMode, defaultTrigger);
    }
    ...
    public Map<Integer, String> getAvailablePins() {
        initialize();
        return new HashMap<>(availablePins);
    }
    ...
    public ChipInfo getChipInfo(String chipPath) {
        ...
        try {
            ...
            String name = LibGpiodV2Native.INSTANCE.gpiod_chip_info_get_name(chipInfo);
            String label = LibGpiodV2Native.INSTANCE.gpiod_chip_info_get_label(chipInfo);
            long numLines = LibGpiodV2Native.INSTANCE.gpiod_chip_info_get_num_lines(chipInfo);
