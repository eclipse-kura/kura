...
public class WpaSupplicantTest extends TestCase {
    ...
    public void setUp() {
        ...
        // Initialize
        try {
            s_wpaSupplicant = WpaSupplicant.getWpaSupplicant(m_iface, WifiMode.INFRA, null, m_ssid,
                    WifiSecurity.SECURITY_WPA, WifiCiphers.CCMP_TKIP, WifiCiphers.CCMP_TKIP, null, m_password, null);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void testConstructor2() {
        ...
        try {
            ...
            s_wpaSupplicant = WpaSupplicant.getWpaSupplicant(m_iface, WifiMode.INFRA, null, ssid,
                    WifiSecurity.SECURITY_WEP, null, null, null, password, null);
            assertNotNull(s_wpaSupplicant);
            ...
            assertTrue("config specifies password", config.contains(password));
    ...
    public void testConstructor3() {
        ...
        try {
            ...
            s_wpaSupplicant = WpaSupplicant.getWpaSupplicant(m_iface, WifiMode.ADHOC, null, ssid,
                    WifiSecurity.SECURITY_NONE, null, null, WpaSupplicant.ALL_CHANNELS, password, null);
            assertNotNull(s_wpaSupplicant);
