...
public class ModemDriver {
        ...
        do {
            ...
            if (TARGET_NAME.equals(KuraConstants.Mini_Gateway.getTargetName())) {
                ...
                if (baseGpio != -1) {
                    ...
                    String gpioDirection = gpioPath + GPIO_DIRECTION_SUFFIX_PATH;
                    String gpioValue = gpioPath + GPIO_VALUE_SUFFIX_PATH;
                    invertGpioValue(gpioIndex, gpioPath, gpioDirection, gpioValue);
                    ...
                    gpioDirection = gpioPath + GPIO_DIRECTION_SUFFIX_PATH;
                    gpioValue = gpioPath + GPIO_VALUE_SUFFIX_PATH;
                    invertGpioValue(gpioIndex, gpioPath, gpioDirection, gpioValue);
    ...
    private int getBaseGpio() throws KuraException {
        String baseFolder = "/sys/class/gpio/";
    ...
    private String readFile(File gpioChipFile) throws IOException {
