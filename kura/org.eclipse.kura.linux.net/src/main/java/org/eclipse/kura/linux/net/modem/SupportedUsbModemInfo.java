...
public enum SupportedUsbModemInfo {
    ...
    Telit_HE910_D   ("HE910-D",  "1bc7", "0021", 7, 0, 3, 0, Arrays.asList(ModemTechnologyType.HSDPA), Arrays.asList(new UsbModemDriver("cdc_acm", "1bc7", "0021"))),
    Telit_GE910		("GE910", "1bc7", "0022", 2, 0, 0, 1, Arrays.asList(ModemTechnologyType.HSDPA), Arrays.asList(new UsbModemDriver("cdc_acm", "1bc7", "0022"))),
