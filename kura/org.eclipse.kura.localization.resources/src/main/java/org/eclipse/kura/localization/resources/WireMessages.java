/*******************************************************************************
f * Copyright (c) 2016, 2020 Eurotech and/or its affiliates and others
 *
...
public interface WireMessages {
    ...
    @En("Specifies wheter the values of all READ or READ_WRITE channels should be emitted in case of a channel event. "
            + "If set to true, the values for all channels will be read and emitted, if set to false, only the value "
            + "for the channel related to the event will be emitted.")
    ...
    @En("If set to PER_CHANNEL, the component will emit a driver-generated timestamp per channel property."
            + " If set to SINGLE_ASSET_GENERATED, the component will emit a single timestamp per request, generated "
            + "by the Asset itself before emitting the envelope."
            + " If set to SINGLE_DRIVER_GENERATED_MAX or SINGLE_DRIVER_GENERATED_MIN, the component will emit a single "
            + "driver generated timestamp being respectively the max (most recent) or min (oldest) among "
            + "the timestamps of the channels.")
