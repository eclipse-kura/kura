...
public class AltitudeStringResource extends StringLwM2mResource {

	private final PositionService ps;
		
	public AltitudeStringResource(PositionService ps) {
		super();
		this.ps = ps;
	}
	...
	protected void handleRead(StringLwM2mExchange exchange) {
		exchange.respondContent(String.valueOf(ps.getNmeaPosition().getAltitude()));
	}
