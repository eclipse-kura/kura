...
public class SimTechSim7000ConfigGenerator implements ModemPppConfigGenerator {
    ...
    private String formPDPcontext(int pdpPid, PdpType pdpType, String apn) {
        ...
        StringBuilder pdpcontext = new StringBuilder(SimTechSim7000AtCommands.pdpContext.getCommand());
        pdpcontext.append('=');
