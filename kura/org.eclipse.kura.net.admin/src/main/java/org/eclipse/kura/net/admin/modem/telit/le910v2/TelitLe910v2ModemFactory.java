...
public class TelitLe910v2ModemFactory implements CellularModemFactory {
    ...
    private Hashtable<String, TelitLe910v2> modemServices = null;
    ...
    public CellularModem obtainCellularModemService(ModemDevice modemDevice, String platform) throws Exception {
        ...
        TelitLe910v2 telitLe910 = this.modemServices.get(key);

        if (telitLe910 == null) {
            telitLe910 = new TelitLe910v2(modemDevice, platform, this.connectionFactory);
