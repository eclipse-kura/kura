...
public class InterfaceState {
    ...
    public InterfaceState(NetInterfaceType type, String interfaceName, NetInterfaceConfigMode ifaceConfigMode)
            throws KuraException {
        this.name = interfaceName;
        this.up = (ifaceConfigMode != NetInterfaceConfigMode.netIPv4ConfigModeManual)
                ? LinuxNetworkUtil.hasAddress(interfaceName) : LinuxNetworkUtil.isUp(interfaceName);
