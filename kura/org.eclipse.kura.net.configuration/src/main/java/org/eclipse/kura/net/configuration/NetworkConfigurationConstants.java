...
public final class NetworkConfigurationConstants {
    ...
    public static final Integer DEFAULT_MODEM_RESET_TIMEOUT_VALUE = 5;
    public static final Integer DEFAULT_MODEM_IDLE_VALUE = 95;
    public static final String DEFAULT_MODEM_ACTIVE_FILTER_VALUE = "inbound";
    public static final Integer DEFAULT_MODEM_LCP_ECHO_FAILURE_VALUE = 0;
    public static final Integer DEFAULT_MODEM_LCP_ECHO_INTERVAL_VALUE = 0;
    ...
    public static final Integer DEFAULT_MODEM_PROFILE_ID_VALUE = 0;
    public static final Integer DEFAULT_MODEM_DATA_COMPRESSION_VALUE = 0;
    public static final Integer DEFAULT_MODEM_HEADER_COMPRESSION_VALUE = 0;
