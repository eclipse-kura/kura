...
public class NetworkConfigurationServiceCommon {
        ...
        public static Tocd getDefinition(Map<String, Object> properties, Optional<List<UsbNetDevice>> usbNetDevices)
                ...
                Tad tad = buildAttributeDefinition(NET_INTERFACES,
                                NetworkConfigurationPropertyNames.PLATFORM_INTERFACES, Tscalar.STRING);
        ...
        public static ComponentConfiguration getConfiguration(final String pid, final Map<String, Object> properties,
                ...
                return new ComponentConfigurationImpl(pid, definition,
                                convertStringsToPasswords(definition, properties));
        }

        private static Map<String, Object> convertStringsToPasswords(final Tocd ocd,
