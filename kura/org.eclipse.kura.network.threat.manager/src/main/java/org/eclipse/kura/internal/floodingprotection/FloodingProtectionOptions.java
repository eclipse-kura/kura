...
public class FloodingProtectionOptions {
    ...
    private static final String[] FLOODING_PROTECTION_FILTER_RULES_IPV6 = {
            ...
            "-A input-kura -p ipv6-icmp -m ipv6-icmp --icmpv6-type 141 -j ACCEPT",
            "-A input-kura -p ipv6-icmp -m ipv6-icmp --icmpv6-type 142 -j ACCEPT",
            "-A input-kura -p ipv6-icmp -m ipv6-icmp --icmpv6-type 148 -j ACCEPT",
            "-A input-kura -p ipv6-icmp -m ipv6-icmp --icmpv6-type 149 -j ACCEPT",
