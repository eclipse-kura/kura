...
public class ConfigurationRestService {
    ...
    public Response updateComponentConfigurations(UpdateComponentConfigurationRequest request) {
        ...
        for (ComponentConfigurationDTO ccr : request.getComponentConfigurations()) {
            ...
            handler.runFallibleSubtask("update:" + ccr.getPid(), () -> {
                ...
                validatePid(ccr.getPid(), configurationProperties);
    ...
    // check whether the PID is tracked by the configuration service or it is a factory component
    private void validatePid(String pid, Map<String, Object> configurationProperties) throws KuraException {

        String serviceFactoryPid = (String) configurationProperties.get(ConfigurationAdmin.SERVICE_FACTORYPID);
