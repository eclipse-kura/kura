...
public class ComponentConfigurationDTO implements Validable {
    ...
    @Schema(description = "Component metadata, when available; not used for configuration updates.")
    private final OcdDTO definition;
    @Schema(description = "Typed component properties. Required for updates; may be absent in metadata-only responses.")
