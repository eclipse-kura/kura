...
public class IdentityRestServiceV1 {
    ...
    @Operation(operationId = "post_identity_v1_identities", summary = "Create a legacy identity",
            description = "Creates a user with the supplied name and credentials.",
    ...
    @Path("/identities")
    @Consumes(MediaType.APPLICATION_JSON)
    @Operation(operationId = "put_identity_v1_identities", summary = "Update a legacy identity",
            description = "Updates the supplied user configuration.",
            requestBody = @RequestBody(required = true, content = @Content(mediaType = MediaType.APPLICATION_JSON,
                    schema = @Schema(implementation = UserDTO.class))))
    @ApiResponse(responseCode = "200", ref = "#/components/responses/EmptySuccess")
    ...
    @Operation(operationId = "post_identity_v1_identities_byName", summary = "Read a legacy identity",
            description = "Looks up a user by the name in the request body.",
            requestBody = @RequestBody(required = true, content = @Content(mediaType = MediaType.APPLICATION_JSON,
                    schema = @Schema(implementation = UserDTO.class))))
    ...
    @Path("/identities")
    @Consumes(MediaType.APPLICATION_JSON)
    @Operation(operationId = "delete_identity_v1_identities", summary = "Delete a legacy identity",
            description = "Deletes the user named in the request body.",
            requestBody = @RequestBody(required = true, content = @Content(mediaType = MediaType.APPLICATION_JSON,
                    schema = @Schema(implementation = UserDTO.class))))
    @ApiResponse(responseCode = "200", ref = "#/components/responses/EmptySuccess")
    ...
    @Operation(operationId = "get_identity_v1_definedPermissions", summary = "List defined permissions",
            description = "Returns permissions available for assignment; no identity role is required.")
    @ApiResponse(responseCode = "200", description = "Requested data.",
    ...
    @Path("/identities")
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(operationId = "get_identity_v1_identities", summary = "List legacy identities",
            description = "Returns the legacy user configuration.")
    @ApiResponse(responseCode = "200", description = "Requested data.",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = UserConfigDTO.class)))
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @SecurityRequirements
    @Operation(operationId = "get_identity_v1_passwordRequirements", summary = "Read password requirements",
            description = "Returns configured password validation options; no identity role is required.")
    @ApiResponse(responseCode = "200", description = "Requested data.",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ValidatorOptionsDTO.class)))
