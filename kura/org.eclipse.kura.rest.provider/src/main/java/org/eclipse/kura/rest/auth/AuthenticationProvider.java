 ...
 * <li>Session authentication: 300</li>
 * </ul>
 */
@ProviderType
public interface AuthenticationProvider {
     ...
     *         An empty optional must be returned both when the request is not meant to be handled by this provider,
     *         usually determined by inspecting the request headers, and when the authentication actually fails. In the
     *         former case the provider should not report an authentication failure, since the request can still be
     *         successfully authenticated by another provider.
     */
