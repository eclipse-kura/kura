...
import org.eclipse.kura.web.shared.model.GwtBSSettings;
import  org.eclipse.kura.web.shared.service.GwtBSSettingService;


public class GwtBSSettingServiceImpl extends OsgiRemoteServiceServlet implements GwtBSSettingService
{
	private static final long serialVersionUID = -3422518194598042896L;

	public void updateSettings(GwtBSSettings settings) throws GwtKuraException
	{
