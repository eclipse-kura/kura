...
public enum GwtBSWifiChannel {
	...
	public static GwtBSWifiChannel valueOf(short channel) {
		try {
			return GwtBSWifiChannel.valueOf("netWifiChannel" + channel);
		} catch (Exception e) {
			return GwtBSWifiChannel.netWifiChannelAuto;
		}
	}
	
	public static short toShort(GwtBSWifiChannel channel) {
