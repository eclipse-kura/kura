...
public class IdsTabUi extends Composite implements Tab, ButtonBar.Listener {

    private static PortForwardingTabUiUiBinder uiBinder = GWT.create(PortForwardingTabUiUiBinder.class);

    interface PortForwardingTabUiUiBinder extends UiBinder<Widget, IdsTabUi> {
    }
    ...
    public void refresh() {
        ...
        this.gwtXSRFService.generateSecurityToken(new AsyncCallback<GwtXSRFToken>() {
            ...
            public void onSuccess(GwtXSRFToken token) {
                IdsTabUi.this.gwtNetworkService.findDeviceFirewallPortForwards(token,
                    ...
                    public void onSuccess(List<GwtFirewallPortForwardEntry> result) {
                        for (GwtFirewallPortForwardEntry pair : result) {
                            IdsTabUi.this.portForwardDataProvider.getList().add(pair);
                        }
                        refreshTable();

                        IdsTabUi.this.buttonBar.setDirty(false);
                        EntryClassUi.hideWaitModal();
                    }
                });
            }
    ...
    @Override
    public void onApply() {
        List<GwtFirewallPortForwardEntry> intermediateList = IdsTabUi.this.portForwardDataProvider.getList();
        ...
        EntryClassUi.showWaitModal();
        IdsTabUi.this.gwtXSRFService.generateSecurityToken(new AsyncCallback<GwtXSRFToken>() {
            ...
            @Override
            public void onSuccess(GwtXSRFToken token) {
                IdsTabUi.this.gwtNetworkService.updateDeviceFirewallPortForwards(token,
    ...
    public void onCancel() {
        IdsTabUi.this.alertDialog.show(MSGS.deviceConfigDirty(), new AlertDialog.Listener() {

            @Override
            public void onConfirm() {
                IdsTabUi.this.refresh();
            }
        });
    }
    ...
    public void onCreate() {
        replaceModalHideHandler(new ModalHideHandler() {
            ...
            public void onHide(ModalHideEvent evt) {
                if (IdsTabUi.this.newPortForwardEntry != null
                        && !duplicateEntry(IdsTabUi.this.newPortForwardEntry)) {
                    IdsTabUi.this.portForwardDataProvider.getList()
                            .add(IdsTabUi.this.newPortForwardEntry);
                    refreshTable();
                    IdsTabUi.this.buttonBar.setDirty(true);
                    IdsTabUi.this.newPortForwardEntry = null;
                }
            }
        });
        showModal(null);
    ...
    public void onEdit() {
        ...
        GwtFirewallPortForwardEntry selection = IdsTabUi.this.selectionModel.getSelectedObject();
        ...
        replaceModalHideHandler(new ModalHideHandler() {
            ...
            @Override
            public void onHide(ModalHideEvent evt) {
                if (IdsTabUi.this.editPortForwardEntry != null) {
                    GwtFirewallPortForwardEntry oldEntry = IdsTabUi.this.selectionModel.getSelectedObject();
                    IdsTabUi.this.portForwardDataProvider.getList().remove(oldEntry);
                    if (!duplicateEntry(IdsTabUi.this.editPortForwardEntry)) {
                        IdsTabUi.this.portForwardDataProvider.getList()
                                .add(IdsTabUi.this.editPortForwardEntry);
                        IdsTabUi.this.portForwardDataProvider.flush();
                        IdsTabUi.this.buttonBar.setDirty(true);
                        IdsTabUi.this.editPortForwardEntry = null;
                    } else {    // end duplicate
                        IdsTabUi.this.portForwardDataProvider.getList().add(oldEntry);
                        IdsTabUi.this.portForwardDataProvider.flush();
                    }
                }
            }
    ...
    public void onDelete() {
        ...
        IdsTabUi.this.alertDialog.show(
                ...
                new AlertDialog.Listener() {
                    ...
                    public void onConfirm() {
                        IdsTabUi.this.portForwardDataProvider.getList()
                                .remove(IdsTabUi.this.selectionModel.getSelectedObject());
                        refreshTable();
                        IdsTabUi.this.buttonBar.setDirty(true);
                        setDirty(true);
                    }
    ...
    private void initModal() {
        ...
        this.cancel.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                IdsTabUi.this.portForwardingForm.hide();
            }
        });
        ...
        this.submit.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                if (IdsTabUi.this.groupInput.getValidationState().equals(ValidationState.ERROR)
                        || IdsTabUi.this.groupOutput.getValidationState().equals(ValidationState.ERROR)
                        || IdsTabUi.this.groupLan.getValidationState().equals(ValidationState.ERROR)
                        || IdsTabUi.this.groupInternal.getValidationState().equals(ValidationState.ERROR)
                        || IdsTabUi.this.groupExternal.getValidationState().equals(ValidationState.ERROR)
                        || IdsTabUi.this.groupPermittedNw.getValidationState().equals(ValidationState.ERROR)
                        || IdsTabUi.this.groupPermittedMac.getValidationState().equals(ValidationState.ERROR)
                        || IdsTabUi.this.groupSource.getValidationState().equals(ValidationState.ERROR)) {
                    return;
                }

                final GwtFirewallPortForwardEntry portForwardEntry = new GwtFirewallPortForwardEntry();
                portForwardEntry.setInboundInterface(IdsTabUi.this.input.getText());
                portForwardEntry.setOutboundInterface(IdsTabUi.this.output.getText());
                portForwardEntry.setAddress(IdsTabUi.this.lan.getText());
                portForwardEntry.setProtocol(IdsTabUi.this.protocol.getSelectedItemText());
                if (IdsTabUi.this.internal.getText() != null
                        && !"".equals(IdsTabUi.this.internal.getText().trim())) {
                    portForwardEntry.setOutPort(Integer.parseInt(IdsTabUi.this.internal.getText()));
                }
                if (IdsTabUi.this.external.getText() != null
                        && !"".equals(IdsTabUi.this.external.getText().trim())) {
                    portForwardEntry.setInPort(Integer.parseInt(IdsTabUi.this.external.getText()));
                }
                portForwardEntry.setMasquerade(IdsTabUi.this.enable.getSelectedItemText());
                if (IdsTabUi.this.permittedNw.getText() != null
                        && !"".equals(IdsTabUi.this.permittedNw.getText().trim())) {
                    portForwardEntry.setPermittedNetwork(IdsTabUi.this.permittedNw.getText());
                } else {
                    portForwardEntry.setPermittedNetwork("0.0.0.0/0");
                }
                if (IdsTabUi.this.permittedMac.getText() != null
                        && !"".equals(IdsTabUi.this.permittedMac.getText().trim())) {
                    portForwardEntry.setPermittedMAC(IdsTabUi.this.permittedMac.getText());
                    IdsTabUi.this.alertDialog.setTitle(MSGS.warning());
                    IdsTabUi.this.alertDialog.show(MSGS.firewallPortForwardFormNotificationMacFiltering(),
                            null);
                }
                if (IdsTabUi.this.source.getText() != null
                        && !"".equals(IdsTabUi.this.source.getText().trim())) {
                    portForwardEntry.setSourcePortRange(IdsTabUi.this.source.getText());
                }

                if (IdsTabUi.this.submit.getId().equals("new")) {
                    IdsTabUi.this.newPortForwardEntry = portForwardEntry;
                    IdsTabUi.this.editPortForwardEntry = null;
                } else if (IdsTabUi.this.submit.getId().equals("edit")) {
                    IdsTabUi.this.editPortForwardEntry = portForwardEntry;
                    IdsTabUi.this.newPortForwardEntry = null;
                }
    ...
    private void setModalFieldsHandlers() {
        ...
        this.input.addBlurHandler(new BlurHandler() {
            ...
            public void onBlur(BlurEvent event) {
                if (IdsTabUi.this.input.getText().trim().isEmpty() || !IdsTabUi.this.input
                        .getText().trim().matches(FieldType.ALPHANUMERIC.getRegex())) {
                    IdsTabUi.this.groupInput.setValidationState(ValidationState.ERROR);
                } else {
                    IdsTabUi.this.groupInput.setValidationState(ValidationState.NONE);
                }
            }
        });
        this.output.addBlurHandler(new BlurHandler() {
            ...
            @Override
            public void onBlur(BlurEvent event) {
                if (IdsTabUi.this.output.getText().trim().isEmpty() || !IdsTabUi.this.output
                        .getText().trim().matches(FieldType.ALPHANUMERIC.getRegex())) {
                    IdsTabUi.this.groupOutput.setValidationState(ValidationState.ERROR);
                } else {
                    IdsTabUi.this.groupOutput.setValidationState(ValidationState.NONE);
                }
            }
        });
        this.lan.addBlurHandler(new BlurHandler() {
            ...
            @Override
            public void onBlur(BlurEvent event) {
                if (IdsTabUi.this.lan.getText().trim().isEmpty()
                        || !IdsTabUi.this.lan.getText().trim().matches(FieldType.IPv4_ADDRESS.getRegex())) {
                    IdsTabUi.this.groupLan.setValidationState(ValidationState.ERROR);
                } else {
                    IdsTabUi.this.groupLan.setValidationState(ValidationState.NONE);
                }
            }
        });
        this.internal.addBlurHandler(new BlurHandler() {
            ...
            @Override
            public void onBlur(BlurEvent event) {
                if (IdsTabUi.this.internal.getText().trim().isEmpty()
                        || !IdsTabUi.this.internal.getText().trim().matches(FieldType.NUMERIC.getRegex())) {
                    IdsTabUi.this.groupInternal.setValidationState(ValidationState.ERROR);
                } else {
                    IdsTabUi.this.groupInternal.setValidationState(ValidationState.NONE);
                }
            }
        });
        this.external.addBlurHandler(new BlurHandler() {
            ...
            @Override
            public void onBlur(BlurEvent event) {
                if (IdsTabUi.this.external.getText().trim().isEmpty()
                        || !IdsTabUi.this.external.getText().trim().matches(FieldType.NUMERIC.getRegex())) {
                    IdsTabUi.this.groupExternal.setValidationState(ValidationState.ERROR);
                } else {
                    IdsTabUi.this.groupExternal.setValidationState(ValidationState.NONE);
                }
            }
        });
        this.permittedNw.addBlurHandler(new BlurHandler() {
            ...
            @Override
            public void onBlur(BlurEvent event) {
                if (!IdsTabUi.this.permittedNw.getText().trim().isEmpty()
                        && !IdsTabUi.this.permittedNw.getText().trim()
                                .matches(FieldType.NETWORK.getRegex())) {
                    IdsTabUi.this.groupPermittedNw.setValidationState(ValidationState.ERROR);
                } else {
                    IdsTabUi.this.groupPermittedNw.setValidationState(ValidationState.NONE);
                }
            }
        });
        this.permittedMac.addBlurHandler(new BlurHandler() {
            ...
            @Override
            public void onBlur(BlurEvent event) {
                if (!IdsTabUi.this.permittedMac.getText().trim().isEmpty()
                        && !IdsTabUi.this.permittedMac.getText().trim()
                                .matches(FieldType.MAC_ADDRESS.getRegex())) {
                    IdsTabUi.this.groupPermittedMac.setValidationState(ValidationState.ERROR);
                } else {
                    IdsTabUi.this.groupPermittedMac.setValidationState(ValidationState.NONE);
                }
            }
        });
        this.source.addBlurHandler(new BlurHandler() {
            ...
            @Override
            public void onBlur(BlurEvent event) {
                if (!IdsTabUi.this.source.getText().trim().isEmpty()
                        && !IdsTabUi.this.source.getText().trim().matches(FieldType.PORT_RANGE.getRegex())) {
                    IdsTabUi.this.groupSource.setValidationState(ValidationState.ERROR);
                } else {
                    IdsTabUi.this.groupSource.setValidationState(ValidationState.NONE);
                }
            }
        });
    }
