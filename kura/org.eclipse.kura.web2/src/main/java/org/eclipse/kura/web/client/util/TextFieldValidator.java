...
public class TextFieldValidator {
    ...
    public enum FieldType {
        ...
        IPV4_ADDRESS_CIDR("ipv4_network", IPV4_ADDRESS_REGEX + "\\/(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\b"),
        IPV6_ADDRESS_CIDR("ipv6_network", IPV6_ADDRESS_REGEX + "\\/(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)"),
        PORT("port", "^[0-9]*$"),
