...
public enum GwtCertificateType {
    ...
    public static GwtCertificateType getCertificateType(String stringCertificateType) {
        ...
        throw new IllegalArgumentException("Cannot convert to GwtCertificateType");
    }
}
