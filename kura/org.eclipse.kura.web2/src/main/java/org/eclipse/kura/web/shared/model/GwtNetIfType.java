...
public enum GwtNetIfType implements Serializable,IsSerializable {
    ...
    WIMAX,
    /**
     * The device is a modem supporting one or more of analog telephone, CDMA/EVDO, GSM/UMTS/HSPA, or LTE standards to
     * access a cellular or wireline data network.
     */
    MODEM,
