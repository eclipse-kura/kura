...
public interface GwtDockerConfigurableGenericService extends GwtRestrictedComponentService {
    ...
    @Audit(componentName = "UI DockerConfigurableGenericManagerService", description = "Get configuration")
    public GwtConfigComponent getConfiguration(GwtXSRFToken token, String pid) throws GwtKuraException;

    @Audit(componentName = "UI DockerConfigurableGenericManagerService", description = "Update configuration")
    public void updateConfiguration(GwtXSRFToken token, GwtConfigComponent component) throws GwtKuraException;

    @Audit(componentName = "UI DockerConfigurableGenericManagerService", description = "Remove configuration")
