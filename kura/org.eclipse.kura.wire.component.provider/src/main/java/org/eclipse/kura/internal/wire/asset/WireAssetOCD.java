...
public class WireAssetOCD extends BaseAssetOCD {
    ...
    private static final String EMIT_ALL_CHANNELS_DESCRIPTION = "Specifies wheter the values "
            + "of all READ or READ_WRITE channels should be emitted in case of a channel event."
    ...
    private static final String TIMESTAMP_MODE_DESCRIPTION = "If set to PER_CHANNEL, the component "
            + "will emit a driver-generated timestamp per channel property."
            ...
            + "If set to SINGLE_DRIVER_GENERATED_MAX or SINGLE_DRIVER_GENERATED_MIN, "
            + "the component will emit a single driver generated timestamp being respectively"
