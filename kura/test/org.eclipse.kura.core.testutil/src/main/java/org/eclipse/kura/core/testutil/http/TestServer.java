...
public class TestServer implements Closeable {
    ...
    private volatile CountDownLatch stallLatch = null;
    ...
    /**
     * Makes the next incoming HTTP request stall until the returned latch is counted down.
     * Allows tests to verify behaviour while a download is in progress.
     */
    public CountDownLatch stallNextRequest() {
        final CountDownLatch latch = new CountDownLatch(1);
        this.stallLatch = latch;
        return latch;
    }
    ...
    private class DownloadServlet extends HttpServlet {
        ...
        protected void doGet(final HttpServletRequest req, final HttpServletResponse resp)
            ...
            final CountDownLatch latch = stallLatch;
            if (latch != null) {
                stallLatch = null;
                try {
                    latch.await();
