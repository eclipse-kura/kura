...
public class JavaNtpClockSyncProviderTest {
    ...
    private JavaNtpClockSyncProvider startedProvider;
    private ScheduledExecutorService startedScheduler;

    @After
    public void stopProvider() throws KuraException {
        if (this.startedProvider != null) {
            this.startedProvider.stop();
            this.startedProvider = null;
        }
        if (this.startedScheduler != null) {
            this.startedScheduler.shutdownNow();
            this.startedScheduler = null;
        }
    }
    ...
    private void initProviderWithProperties(JavaNtpClockSyncProvider provider) throws KuraException {
        ...
        this.startedProvider = provider;
        this.startedScheduler = scheduler;
