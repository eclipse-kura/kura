...
public class DeviceAlreadyExistsException extends DeviceException {
    ...
    /**
     * Constructs a new {@code DeviceAlreadyExistsException} instance with {@code null} as its detailed
     * reason message.
     */
    ...
    /**
     * Constructs a new {@code DeviceAlreadyExistsException} instance with the specified detailed
     * reason message. The error message string {@code message} can later be retrieved by the
