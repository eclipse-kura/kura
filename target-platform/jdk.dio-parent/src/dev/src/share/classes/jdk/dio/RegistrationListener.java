...
public interface RegistrationListener<P extends Device<? super P>> extends EventListener {
     ...
     *
     * @param event
     *            the device registration event that occurred.
     */
    void deviceRegistered(RegistrationEvent<P> event);

    /**
     * Invoked when a device is unregistered.
     *
     * @param event
     *            the device unregistration event that occurred.
     */
    void deviceUnregistered(RegistrationEvent<P> event);
}