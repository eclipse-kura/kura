...
public class InvalidInputSamplingRateException extends RuntimeException {
    ...
    /**
     * Constructs a new {@code InvalidInputSamplingRateException} with {@code null} as its detailed
     * reason message.
     */
    ...
    /**
     * Constructs a new {@code InvalidInputSamplingRateException} with the specified detail message.
     * The error message string {@code message} can later be retrieved by the
