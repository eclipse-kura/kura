...
public class InvalidPulseRateException extends RuntimeException {
    ...
    /**
     * Constructs a new {@code InvalidPulseRateException} with {@code null} as its detailed reason message.
     */
    ...
    /**
     * Constructs a new {@code InvalidPulseRateException} with the specified detail message. The error message string
