 ...
 * the decimal string representation of a UART channel number as may be returned by a call to
 ...
 * <dl>
 * <dt>{@code open}</dt>
 * <dd>open and access an UART channel functions (see {@link DeviceManager#open DeviceManager.open})</dd>
...
public class UARTPermission extends DevicePermission {
    ...
    /**
     * Constructs a new {@code UARTPermission} with the specified target name and the implicit {@code open} action.
     *
     * @param name
    ...
    /**
     * Constructs a new {@code UARTPermission} instance with the specified target name and action list.
     *
     * @param name
     *            the target name (as defined above).
     * @param actions
