...
/**
 * @title Custom spi Policy
 * @author stanislav.smirnov@oracle.com
 */
public class SPIPolicy extends Policy {

    private static PermissionCollection permissions;

    public SPIPolicy(DeviceMgmtPermission deviceMgmtPermission,
            SPIPermission spiPermission){
        super();
        init(deviceMgmtPermission, spiPermission);
    }

    private void init(DeviceMgmtPermission deviceMgmtPermission, SPIPermission spiPermission) {
        if (permissions == null) {
        ...
        addSpiPermission(spiPermission);
    }
    ...
    public void addSpiPermission(SPIPermission spiPermission) {
        if (spiPermission != null) {
            permissions.add(spiPermission);
        }
    }
