...
public class ConfigurationServiceTest extends TestCase implements IConfigurationServiceTest, ConfigurableComponent {
    ...
    private static final String APP_ID = "CONF-V1";
    private static final String RESOURCE_CONFIGURATIONS = "configurations";
    ...
    public void testRemoteConfiguration() throws Exception {
        ...
        sb = new StringBuilder(CloudletTopic.Method.EXEC.toString()).append("/").append(RESOURCE_SNAPSHOT);
        ...
        resp = cloudEndpointPublisher.call(APP_ID, sb.toString(), payload, 10000);
